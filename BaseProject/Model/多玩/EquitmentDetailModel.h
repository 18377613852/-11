...
@class EquitmentDetailExtattrsModel;
@interface EquitmentDetailModel : BaseModel

@property (nonatomic, strong) EquitmentDetailExtattrsModel *extAttrs;
...
@end
@interface EquitmentDetailExtattrsModel : NSObject
