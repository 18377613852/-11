...
@class MusicCategoryContentAlbumModel,MusicCategoryContentTracksModel,MusicTracksListModel;
@interface MusicCategoryContentModel : BaseModel

@property (nonatomic, strong) MusicCategoryContentTracksModel *tracks;

@property (nonatomic, strong) MusicCategoryContentAlbumModel *album;
...
@end
@interface MusicCategoryContentAlbumModel : NSObject
...
@interface MusicCategoryContentTracksModel : NSObject

@property (nonatomic, assign) NSInteger maxPageId;

@property (nonatomic, strong) NSArray<MusicTracksListModel *> *list;
...
@interface MusicTracksListModel : NSObject
